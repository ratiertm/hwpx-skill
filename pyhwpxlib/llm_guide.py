...
GUIDE = r"""
# pyhwpxlib v0.18.3 — LLM Quick Reference Guide
...
| Version | Highlights |
|---------|-----------|
| **0.18.3** | MCP entry-point fix — `python -m pyhwpxlib.mcp_server` now works (added missing `__main__.py`). Standard Claude Desktop / Cursor MCP configs work without `.server` suffix. License-doc cleanup. |
| **0.18.2** | License declaration — PolyForm Noncommercial 1.0.0 + Apache 2.0 (dual). No code changes; byte-identical to 0.18.1. Personal/academic/non-profit free; any commercial use (incl. small teams, freelancers) requires commercial license. Commercial inquiries: ratiertm@gmail.com |
