...
from cli_anything.hwpx.core.converter import (
    MD_STYLES, DEFAULT_STYLE, convert_markdown_to_hwpx,
    strip_inline_md, _PAGE_WIDTH,
)

# Backward compat alias
_convert_markdown_to_hwpx = convert_markdown_to_hwpx
_strip_inline_md = strip_inline_md
...
# (MD→HWPX converter moved to cli_anything.hwpx.core.converter)
